...
packagename=github.com/sheikh-arman/controller-appscode-api
...
cd $depelopmentDir && go get sigs.k8s.io/controller-tools/cmd/controller-gen@v0.14.0
cd $depelopmentDir && go install sigs.k8s.io/controller-tools/cmd/controller-gen@v0.14.0
echo $depelopmentDir
